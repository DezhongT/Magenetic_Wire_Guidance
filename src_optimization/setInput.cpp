...
setInput::setInput()
{
  ...
  AddOption("scaleRender", "scaleRender", scaleRender);
  AddOption("dBar", "dBar", dBar);
  AddOption("stiffness", "stiffness", stiffness);
  AddOption("speed", "speed", speed);
  AddOption("mu", "mu", mu);
  AddOption("epsilonV", "epsilonV", epsilonV);
  AddOption("stopTime", "stopTime", stopTime);
  AddOption("caseOpt", "caseOpt", caseOpt);
  AddOption("deltaBaStep", "deltaBaStep", deltaBaStep);
  AddOption("timeWait", "timeWait", timeWait);
}
